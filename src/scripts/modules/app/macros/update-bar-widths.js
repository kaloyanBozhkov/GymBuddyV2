...
export default (container, currentServ, totalMacros) => {
    ...
    $(`${container} #totalCalories`).html(BaseMacros.returnTotalCalories(totalMacros.fats, totalMacros.carbs, totalMacros.proteins));//total calories shown have no need of dot decimal notation
